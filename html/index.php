...
<html>
	<head>
		...
		<title>Goggle Hive Media Server</title>
	...
	<body>
		...
		<main>
			<div>
				<h1>Welcome to the Goggle Hive Media Storage Server!</h1>
				<p>Click <a href="login.php">here</a> to login or signup with the form below:</p>
